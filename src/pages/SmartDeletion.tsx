  ...
  useEffect(() => {
    ...
    if (storedResults) {
      try {
        ...
        console.error('❌ SmartDeletion - Erreur parsing résultats:', error);
      }
    }
    ...
    if (storedAuth) {
      try {
        ...
        console.error('❌ SmartDeletion - Erreur parsing auth:', error);
      }
    }
  }, []);

  const handleDeleteSelected = async (emailIds: string[]) => {
    console.log('🗑️ SmartDeletion - Suppression demandée:', emailIds.length);
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="text-right">
            <h1 className="text-2xl font-bold text-gray-900">Suppression Intelligente</h1>
